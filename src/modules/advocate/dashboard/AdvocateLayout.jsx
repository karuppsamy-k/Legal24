...
import { Clock, Briefcase, Calendar, FileText, MessageSquare, Users, CreditCard } from 'lucide-react'
...
const navItems = [
  ...
  { label: 'Consultations', id: 'advocate-consultations', icon: <Users size={18} /> },
  { label: 'Instant Consults', id: 'advocate-instant-consults', icon: <Users size={18} color="#fbbf24" /> },
  ...
  { label: 'Payments', id: 'advocate-payments', icon: <CreditCard size={18} /> }
]
